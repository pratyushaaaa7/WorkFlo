...
const SVRs = () => {
  ...
  const downloadSVR = async (id: string, url: string, fileName: string, uploadedBy?: string) => {
    ...
    return (
      ...
      >
        ...
        <View className="flex-row items-center">
          ...
          {/* Download Button */}
          <TouchableOpacity
            onPress={() => downloadSVR(item._id, item.url, item.fileName, item.uploadedBy?.fullName)}
